...
execute unless entity @s[tag=mtc_open] run event entity @e[scores={mtc_calc1=0}] openB
execute unless entity @s[tag=mtc_open] as @e[family=mtc_body,scores={mtc_calc1=0}] at @s run scriptevent mtc:inner_pg_openL
execute unless entity @s[tag=mtc_open] as @e[family=mtc_body,scores={mtc_calc1=0}] at @s run scriptevent mtc:inner_pg_openR
execute unless entity @s[tag=mtc_open] run tag @e[scores={mtc_calc1=0}] add mtc_openB
