...
execute as @e[family=mtc_body,tag=mtc_parent,scores={mtc_calc1=0},c=1] at @s run scoreboard players operation @s mtc_calc2 -= @s mtc_notAM
...
execute as @e[family=mtc_body,tag=mtc_parent,scores={mtc_calc1=0},c=1] at @s if score @s mtc_calc2 matches ..-1 run scoreboard players add @s mtc_not 1
...
# 手動
execute as @e[family=mtc_body,tag=mtc_parent,scores={mtc_calc1=0},c=1] run tag @s add mtc_manual