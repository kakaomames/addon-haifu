...
execute as @e[family=mtc_body,tag=mtc_parent,scores={mtc_calc1=0},c=1] at @s if score @s mtc_calc2 matches ..-1 run scoreboard players operation @s mtc_not = @s mtc_notBM
